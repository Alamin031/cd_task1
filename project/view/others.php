        ...
        <form>
         ...
         // echo $name2;
          ?>
           ...
           <tr><td> Phone Number </td><td> <input type="text" name="numer" > </td></tr>
         ...
         <td><input type="file" id="myfile" name="myfile"> </td></tr>
            <tr><td> <a href="../view/inpormation.php"><input type="Submit"name="Submit" value="Submit"> 
            <input type="Reset"  ></td></tr>

            
            <tr><td> <a href="../view/inpormation.php"><input type="button" value="Others Registration" ></a>
